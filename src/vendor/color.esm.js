...
/**
 * This file is included directly because of bugs in the packaged version.
 * Source file: https://colorjs.io/dist/color.esm.js
 * See also: https://github.com/LeaVerou/color.js/issues/134
 */
...
class Color {
	...
	static defineSpace ({id, inherits}) {
		...
		if (space.properties) {
			extend(Color.prototype, space.properties);
		}
	...
	static defineShortcut(prop, obj = Color.prototype, long) {
		...
		Object.defineProperty(obj, prop, {
			get () {
				return value(this, Color.shortcuts[prop]);
			},
			set (value$1) {
				return value(this, Color.shortcuts[prop], value$1);
			},
			configurable: true,
			enumerable: true
		});
